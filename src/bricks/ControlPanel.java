...
public class ControlPanel extends JPanel {
    private JTextField tfLevel = new JTextField(""
            + ErsBlocksGame.DEFAULT_LEVEL), tfScore = new JTextField("0");

    private JButton btPlay = new JButton("Play"),
            btPause = new JButton("Pause"), btStop = new JButton("Stop"),
     ...
     * 控制面板类的构造函数
     *
     * @param game ErsBlocksGame, ErsBoxesGame类的一个实例引用， 方便直接控制ErsBoxesGame类的行为。
     */
