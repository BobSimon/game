...
/**
 * @Author: Bob Simon
 * @Description:  画布类，内有<行数> * <列数>个方格类实例。 继承自JPanel类。 ErsBlock线程类动态改变画布类的方格颜色，画布类通过
 *   检查方格颜色来体现ErsBlock块的移动情况。
 * @Date: Created in 15:55 2018\5\3 0003
 */
public class GameCanvas extends JPanel {
	 ...
	 * 
	 * @param rows
	 *            与public GameCanvas(int rows, int cols)同
	 * @param cols
	 *            与public GameCanvas(int rows, int cols)同
	 * @param backColor
	 *            Color, 背景色
